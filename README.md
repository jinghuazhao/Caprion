...
This is experimented on several software including HIBAG, CookHLA and SNP2HLA  as desribed [here](https://cambridge-ceu.github.io/csd3/applications/CookHLA.html). The whole cohort imputation using CookHLA has the running time exceeding the system limit, so a SLURM job is used instead.
