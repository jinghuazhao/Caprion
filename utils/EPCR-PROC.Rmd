...
```{r qqman1, fig.cap="Figure 1. Q-Q and manhattan plots", fig.height=8, fig.wdith=12, echo=FALSE}
p1 <- ggdraw() + draw_image("EPCR-PROC/Q9UNN8_invn_turboqq.png")
p2 <- ggdraw() + draw_image("EPCR-PROC/Q9UNN8_invn_turboman.png")
# plot_grid(p1, p2)
p3 <- ggdraw() + draw_image("EPCR-PROC/P04070_invn_turboqq.png")
p4 <- ggdraw() + draw_image("EPCR-PROC/P04070_invn_turboman.png")
# plot_grid(p3, p4)
include_graphics(c("EPCR-PROC/Q9UNN8_invn_turboqq.png","EPCR-PROC/Q9UNN8_invn_turboman.png"))
include_graphics(c("EPCR-PROC/P04070_invn_turboqq.png","EPCR-PROC/P04070_invn_turboman.png"))
```
...
```{r heatmap2, fig.cap="Figure 3. Phase II heatmap", fig.height=7, fig.wdith=8 , echo=FALSE}
...
```{r qqman2, fig.cap="Figure 4. Q-Q and manhattan plots for EPCR", out.wdith="50%", echo=FALSE}
