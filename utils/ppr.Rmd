...
$$
The covariates were sex, age, bmi and 20 PCs. For phase II model, the covariates were sex, age, sample classification according to model-based clustering.
...
It is somewhat counterintuitive not to see more significant results from phase II although the sample size is seven fold larger; the impact of the systematic bias in the measurement was unclear.
