...
Step 2 is implemented using `bedtools`. Step 3 can be facilitaed with an R:
...
```{r normal, echo=FALSE, fig.cap="Figure 2. Normal(0,1) distribution", fig.width=6, fig.height=4}
z0 <- 1.96
z <- 5
