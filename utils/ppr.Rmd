...
1. Obtain a list of genomewide significant variants and their (+/- 1Mb) flanking regions
2. Identify non-overlapping regions
3. Select the most significant variant in these regions as sentinels

in cases there are ties, keep only one of them.
