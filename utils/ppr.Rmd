...
```{r Q9Y6E2-BZW2, fig.cap="Figure 3. Q9Y6E2-BZW2 Miami plot", fig.height=5, fig.wdith=6, echo=FALSE}
include_graphics("miamiplot/Q9Y6E2-BZW2-phase1-phase2.png")
```

## Overlap of sentinels

Our focus here is on $10^{-6}$ and $5 \times 10^{-8}$.
...
It appears that a study of 196 individuals is sufficient to see statistical significance at $10^{-5}$.
