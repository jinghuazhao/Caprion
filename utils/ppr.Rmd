...
The clustering based on PC1 and PC2 featured poorly with K-means \@ref(fig:kmeans) but perfectly with model-based clustering \@ref(fig:mclust), which 
...
```{r kmeans, fig.cap="K-means clustering of phase II proteins", echo=FALSE}
include_graphics("clustering-2020-0.png")
```

```{r mclust, fig.cap="Model-based clustering of phase II proteins", echo=FALSE}
include_graphics("clustering-2020-1.png")
```

```{r P22626_ROA2, fig.cap="P22626-ROA2 Miami plot", echo=FALSE}
